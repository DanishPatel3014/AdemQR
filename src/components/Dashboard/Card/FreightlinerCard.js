      ...
      <Stack direction={{base : 'column',md : 'row'}}>
        ...
        <Stack w="100%">
          <HStack spacing={4} py={2} w={'100%'}>
            ...
            >
              <Text fontSize={{base:'12px',  sm : '14px', md:'14px', xl:'18px', "2xl": '18px'}} fontWeight={'500'} color={'#fff'}>
                Freightliner
              </Text>
              <Text noOfLines={1} fontSize={{base:'12px',  sm : '14px', md:'14px', xl:'14px', "2xl": '14px'}} color={'#F3EEFE'}>
                Driver/Trucking Co
              </Text>
          ...
          >
            ...
            >
              <Stack direction={'row'}>
                <Text flex={2} color={'#834CD7'}   fontSize={{base:'12px',  sm : '12px', md:'12px', xl:'16px', "2xl": '16px'}}>
                  Route
                </Text>
                <Text flex={1} color={'#834CD7'}   fontSize={{base:'12px',  sm : '12px', md:'12px', xl:'16px', "2xl": '16px'}}>
                  Driver:
                </Text>
                <Text flex={1} color={'#834CD7'}   fontSize={{base:'12px',  sm : '12px', md:'12px', xl:'16px', "2xl": '16px'}}>
                  Driver:
              ...
              <Stack    direction={'row'} alignItems={'center'}>
                <Text
                  fontSize={{base:'12px',  sm : '12px', md:'12px', xl:'16px', "2xl": '16px'}}
                  flex={2}
                  color={'#fff'}
                  noOfLines={1}
            ...
            <Stack w={{base : '100%', md : "30%"}} direction={'row'} m={'0 !important'}>
              <Stack
                w={{ base: '70%', sm: '70%' ,md: '80%', xl: '70%', '2xl': '45%' }}
                p={'15px'}
                bg={'#000D41'}
              ...
              >
                <HStack>
                  <Text noOfLines={1}  fontSize={{base:'11px',  sm : '11px', md:'11px', xl:'14px', "2xl": '14px'}} flex={1} color={'#834CD7'}>
                    Ad Dimensions
                  </Text>
                </HStack>
                <HStack>
                  <Text flex={1}  fontSize={{base:'11px',  sm : '11px', md:'11px', xl:'14px', "2xl": '14px'}} color={'#fff'}>
                    10ft x 4ft
                  </Text>
                </HStack>
              </Stack>
